...
using ARMBit.Server;
using ARMBit.Server.Models.Identity;
using ARMBit.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "ARMBit.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "ARMBit.Shared.xml"));
