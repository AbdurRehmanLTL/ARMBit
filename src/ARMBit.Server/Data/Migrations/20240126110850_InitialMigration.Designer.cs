...
namespace ARMBit.Server.Data.Migrations
{
    ...
    [Migration("20240126110850_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARMBit.Server.Models.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ARMBit.Server.Models.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ARMBit.Server.Models.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            BirthDate = 1306790461440000300L,
            ...
            modelBuilder.Entity("ARMBit.Server.Models.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedOn = 1307462860800000300L,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedOn = 1307454013440000300L,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedOn = 1307436318720000300L,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = 1307427471360000300L,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 1,
                            CreatedOn = 1307418624000000300L,
                        ...
                        new
                        {
                            Id = 15,
                            CategoryId = 4,
                            CreatedOn = 1307445166080000300L,
                            Description = "",
                            Name = "530e",
                            Price = 56545m
                        },
                        ...
                        new
                        {
                            Id = 19,
                            CategoryId = 4,
                            CreatedOn = 1307409776640000300L,
                            Description = "",
                            Name = "IX",
                            Price = 87000m
                        },
            ...
            modelBuilder.Entity("ARMBit.Server.Models.Products.Product", b =>
                {
                    b.HasOne("ARMBit.Server.Models.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ARMBit.Server.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ARMBit.Server.Models.Identity.User", null)
                        .WithMany()
